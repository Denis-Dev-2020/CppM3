...
ariel::Board board;
TEST_CASE("good case"){
    CHECK(board.read(0,0,Direction::Horizontal,7) == 0);
    CHECK(board.post(100,100,Direction::Horizontal,"abcd") == 0);
    CHECK(board.read(100,100,Direction::Horizontal,4) == 0);
    CHECK(board.post(250,250,Direction::Vertical,"hi") == 0);
    CHECK(board.read(250,250,Direction::Vertical,2) == 0);
    CHECK(board.post(50,50,Direction::Horizontal,"xyz") == 0);
    CHECK(board.read(50,50,Direction::Vertical,4) == 0);
    CHECK(board.post(200,200,Direction::Vertical,"hello cpp") == 0);
    CHECK(board.read(200,203,Direction::Horizontal,7) == 0);
    CHECK(board.post(120,120,Direction::Vertical,"uriya") == 0);
    CHECK(board.read(121,120,Direction::Vertical,5) == 0);
    CHECK(board.post(140,10,Direction::Horizontal,"asher") == 0);
    CHECK(board.read(140,13,Direction::Horizontal,2) == 0);
    CHECK(board.post(80,80,Direction::Horizontal,"efg") == 0);
    CHECK(board.read(80,78,Direction::Horizontal,7) == 0);
    CHECK(board.post(120,121,Direction::Vertical,"shemla") == 0);    
    CHECK(board.read(118,121,Direction::Vertical,5) == 0);
    CHECK(board.post(50,51,Direction::Horizontal,"xx") == 0);
    CHECK(board.read(50,50,Direction::Horizontal,3) == 0);
